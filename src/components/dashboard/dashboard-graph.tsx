...
const DashboardGraph = () => {
  return (
    <motion.section 
      className="w-full mt-[10px] sm:mt-[14px] lg:mt-[30px] border-[2px] border-[#F0F1F7] rounded-[8px] bg-white"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      <div className='w-full flex h-[302px] sm:h-auto'>
        <div className='w-full sm:w-2/3 pr-4 h-full flex flex-col'>
          <div className='flex flex-col justify-between mb-4 p-8'>
            ...
            <div className='w-full flex flex-col sm:flex-row items-center justify-between'>
              ...
              <div className='flex sm:flex items-center gap-6'>
                <div className='flex items-center gap-2'>
                  <div className='w-4 border-[1px] rounded-full border-[#3751ff]'></div>
                  <span className='text-[12px] text-[#9FA2B4] font-semibold tracking-[0.1px]'>Today</span>
                </div>
                <div className='flex items-center gap-2'>
                  <div className='w-4 border-[1px] rounded-full border-slate-300'></div>
        ...
        <div className='w-1/3 hidden sm:flex flex-col border-l-[2px] border-[#F0F1F7] text-center'>
          {chartData.map((obj, index) => (
            <div key={index} className='p-6 border-b-[2px] last:border-b-0 border-[#F0F1F7] flex-1 flex flex-col justify-center items-center'>
